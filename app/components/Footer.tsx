      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2.5">
              <Link href="/criacao-websites-aveiro" className="text-gray-400 hover:text-white text-sm transition-colors">
                Criação de Websites
              </Link>
              ...
              <Link href="/ciberseguranca-pme" className="text-gray-400 hover:text-white text-sm transition-colors">
                Cibersegurança
              </Link>
              <Link href="/chatbots-ia-whatsapp" className="text-gray-400 hover:text-white text-sm transition-colors">
                Chatbots com IA
              </Link>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} Zarix. Todos os direitos reservados.
          </p>
          <button
            onClick={openPrivacy}
            className="text-gray-500 hover:text-white text-xs transition-colors underline"
          >
