        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-1">
              {/* Instagram */}
              <a href="https://www.instagram.com/zarix_it/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#7A8295] hover:text-cyan transition-colors">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61590085367925" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[#7A8295] hover:text-cyan transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/zarixit" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#7A8295] hover:text-cyan transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
